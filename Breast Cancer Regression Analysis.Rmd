---
title: "Breast Cancer Regression Analysis - Ivy Fong"
...
MSE (ridge regression) = 985.8034, MSE (lasso) = 972.7765.
  ...
  The model comparison process must be separate from the parameter tuning process, and so different training, validation and test sets must be used. Thus, to compare the performance of the two prediction methods on these data, we could use CV, LOO, validation set, or nested cross-validation methods.